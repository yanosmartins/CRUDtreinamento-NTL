...
$page_nav['faturamento']['sub']['tabela']['sub']["funcao"]["active"] = true;
...
<script src="<?php echo ASSETS_URL; ?>/js/business_tabelaBasicaFuncao.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript">
    ...
    function novo() {
        $(location).attr('href', 'tabelaBasica_funcaoCadastro.php');
    }

    function voltar() {
        $(location).attr('href', 'tabelaBasica_funcaoFiltro.php');
    }
