...
$condicaoExcluirOK = (in_array('INDICEREAJUSTE_EXCLUIR', $arrayPermissao, true));
...
$page_nav['faturamento']['sub']['tabela']['sub']["indiceReajuste"]["active"] = true;
include("inc/nav.php");
?>
        ...
        <section id="widget-grid" class="">
            <!-- <div class="row" style="margin: 0 0 13px 0;">
                <?php if ($condicaoGravarOK) { ?>
                    <a class="btn btn-primary fa fa-file-o" aria-hidden="true" title="Novo" href="<?php echo APP_URL; ?>/cadastroIndiceReajuste.php" style="float:right"></a>
                <?php } ?>
            </div> -->
                ...
                <article class="col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable centerBox">
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
                        <header>
                            ...
                            <h2>Índice de Reajuste
                            </h2>
                        </header>
                        <div>
                            <div class="widget-body no-padding">
                                <form action="javascript:gravar()" class="smart-form client-form" id="formIndiceReajuste" method="post">
...
?>
<script src="<?php echo ASSETS_URL; ?>/js/business_tabelaBasicaIndiceReajuste.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript">
    ...
    function excluir() {
        ...
        excluirIndiceReajuste(id, function(data) {
    ...
    function carregaIndiceReajuste() {
