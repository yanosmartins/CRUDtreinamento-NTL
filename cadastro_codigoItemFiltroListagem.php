...
<div class="table-container">
    <div class="table-responsive" style="min-height: 115px; border: 1px solid #ddd; margin-bottom: 13px; overflow-x: auto;">
        <table id="tableSearchResult" class="table table-bordered table-striped table-condensed table-hover dataTable">
            <thead>
                <tr role="row">
                    <th class="text-left" style="min-width:30px;">codigoItem</th>
                    <th class="text-left" style="min-width:30px;">codigoFabricante</th>
                    <th class="text-left" style="min-width:30px;">descricaoItem</th>
                    <th class="text-left" style="min-width:30px;">estoque</th>
                    <th class="text-left" style="min-width:30px;">grupoItem</th>
                    <th class="text-left" style="min-width:30px;">localizacaoItem</th>
