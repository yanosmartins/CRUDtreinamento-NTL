...
$page_nav['faturamento']['sub']['tabela']['sub']["remuneracao"]["active"] = true;
...
<script src="<?php echo ASSETS_URL; ?>/js/business_tabelaBasicaRemuneracao.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript">
    ...
    function novo() {
        $(location).attr('href', 'tabelaBasica_remuneracaoCadastro.php');
    }

    function voltar() {
        $(location).attr('href', 'tabelaBasica_remuneracaoFiltro.php');
    }
