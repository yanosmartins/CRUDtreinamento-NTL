        ...
        <table id="tableSearchResult" class="table table-bordered table-striped table-condensed table-hover dataTable">
            <thead>
                <tr role="row">
                    ...
                    <th class="text-left" style="min-width:30px;" scope="col">Nome do Responsável</th>
            ...
            <tbody>
                ...
                foreach($result as $row) {
                    ...
                    echo '<tr >';  
                    echo '<td class="text-left"><a href="tabelaBasica_responsavelCadastro.php?id=' . $id . '">' . $nome . '</a></td>';
