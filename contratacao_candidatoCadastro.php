...
$page_nav['operacao']['sub']['recursoshumanos']['sub']["contratacao"]['sub']['candidato']["active"] = true;
include("inc/nav.php");
                                            ...
                                            <div id="collapseCadastro" class="panel-collapse collapse in">
                                                <div class="panel-body no-padding">
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="row">
                                                            <section class="col col-12">
                                                                <legend><strong>Dados para Contato</strong></legend>
                                                            </section>
                ...
                recuperaFuncionario(idd,
                    function(data) {
                        if (data.indexOf('failed') > -1) {} else {
                            ...
                            banco = banco.split("-");
                            banco = banco[0].trim();
                            var conta = tipoConta //tipoConta:  1 - Corrente  2-Poupança
