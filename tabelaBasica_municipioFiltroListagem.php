            ...
            <tbody>
                <?php 
                    ...
                    if ($_GET["municipioFiltro"] != "") {
                        ...
                        $where=$where." and (descricao like '%' + "."replace('".$municipioFiltro."',' ','%') + "."'%')";
                    }
                    
                    if ($_GET["unidadeFederacaoFiltro"] != "" ) {
                        $unidadeFederacaoFiltro = $_GET["unidadeFederacaoFiltro"];
                        $where=$where." and (unidadeFederacao like '%' + "."replace('".$unidadeFederacaoFiltro ."',' ','%') + "."'%')";
                    }
                    ...
                    $sql="SELECT codigo,descricao,unidadeFederacao,ativo FROM Ntl.municipio ";
                    $sql= $sql . $where;
                    ...
                    while (($row = odbc_fetch_array($result))) {
                        ...
                        echo '<tr >'; 
                        echo '<td class="text-left"><a href="tabelaBasica_municipioCadastro.php?codigo='.$id.'">'.$municipio.'</a></td>';
