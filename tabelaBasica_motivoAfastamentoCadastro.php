...
$condicaoAcessarOK = (in_array('MOTIVOAFASTAMENTO_ACESSAR', $arrayPermissao, true));
$condicaoGravarOK = (in_array('MOTIVOAFASTAMENTO_GRAVAR', $arrayPermissao, true));
$condicaoExcluirOK = (in_array('MOTIVOAFASTAMENTO_EXCLUIR', $arrayPermissao, true));
...
$page_title = "Motivo do Afastamento";
...
$page_nav['beneficio']['sub']['tabela']['sub']["motivoAfastamento"]["active"] = true;
...
<script src="<?php echo ASSETS_URL; ?>/js/business_tabelaBasicaMotivoAfastamento.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript">
    ...
    function voltar() {
        $(location).attr('href', 'tabelaBasica_motivoAfastamentoFiltro.php');
    }
    ...
    function gravar() {
        ...
        gravaMotivoAfastamento(id, ativo, descricao,
            function(data) {
