...
$page_nav["estoque"]["sub"]["tabela"]["sub"]["naturezaOperacao"]["active"] = true;
...
<script src="<?php echo ASSETS_URL; ?>/js/business_tabelaBasicaNaturezaOperacao.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript">
    ...
    function novo() {
        $(location).attr('href', 'tabelaBasica_naturezaOperacaoCadastro.php');
    }

    function voltar() {
        $(location).attr('href', 'tabelaBasica_naturezaOperacaoFiltro.php');
    }
