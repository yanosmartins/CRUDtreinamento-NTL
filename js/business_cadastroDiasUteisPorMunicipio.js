function gravaDiasUteisPorMunicipio(id, ativo, unidadeFederacao, municipio, cidade, qtdDiasJaneiro,qtdDiasFevereiro, qtdDiasMarco,
    ...
    $.ajax({
        url: 'js/sqlscope_tabelaBasicaDiasUteisPorMunicipio.php',
        dataType: 'html', //tipo do retorno
        type: 'post', //metodo de envio
        data: {funcao: "grava", id:id, ativo:ativo, unidadeFederacao:unidadeFederacao, municipio:municipio, cidade:cidade, qtdDiasJaneiro:qtdDiasJaneiro, qtdDiasFevereiro:qtdDiasFevereiro,
