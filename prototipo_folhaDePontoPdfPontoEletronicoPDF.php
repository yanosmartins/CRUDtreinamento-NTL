...
// // $sql = "SELECT F.nome,BP.matricula,BP.horaEntrada,BP.horaSaida,BP.horaInicio,BP.horaFim,P.imprimeCargo,P.apelido,P.estado,
// //         P.municipioFerias,C.descricao AS 'cargo', BP.tipoEscala, BP.escalaDia,BP.registraPonto, BP.dataRegistro, BP.fimPonto, BP.bancoHoras,
// //         BP.registraPausa, BP.inicioPrimeiraPausa, BP.fimPrimeiraPausa, BP.inicioSegundaPausa, BP.fimSegundaPausa
...
// //         INNER JOIN Ntl.cargo C ON C.codigo = BP.cargo  
// //         WHERE F.codigo = $id AND BP.ativo = 1";
...
//                     if (($registro['horaEntrada'] == "00:00:00") && $registro['horaSaida'] == "00:00:00" && $registro['descricao'] == '') {
...
//                     $pdf->setX(126);
//                     $pdf->SetFont('Arial', 'B', 8);
//                     $pdf->Cell(16.65,  6.61, iconv('UTF-8', 'windows-1252', $registro['descricao']), 0, 0, "L", 0); // descricao funcionario
...
//                         if ($tipoEscala == 1) { //Normal
//                             if ($registraPonto == 1 && $escalaDia == 3 && $inicioRegistroPonto[0] <= $diaMesAno && $registro['descricao'] == '') {
//                                 $pdf->setX(126.8);
//                                 $pdf->SetFont('Arial', 'B', 8);
//                                 if ($fimRegistroPonto[0] != "") {
//                                     if (($fimRegistroPonto[0] >= $diaMesAno) && $diaMesAno < $dataAtual) {
...
//                 if (($registro['horaEntrada'] == "00:00:00") && $registro['horaSaida'] == "00:00:00") {
//                     if ($tipoEscala == 1) {
//                         if ($registraPonto == 1 && $inicioRegistroPonto[0] <= $diaMesAno && $registro['descricao'] == '') {
//                             $pdf->setX(126.8);
//                             $pdf->SetFont('Arial', 'B', 8);
//                             if ($fimRegistroPonto[0] != "") {
//                                 if (($fimRegistroPonto[0] >= $diaMesAno) && $diaMesAno < $dataAtual) {
