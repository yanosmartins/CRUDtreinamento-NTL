                                                    ...
                                                    <fieldset>
                                                        <div class="row smart-form">
                                                            ...
                                                            <section class="col col-4">
                                                                <label class="label" for="descricao">Nome do Modal</label>
                                                                <label class="input">
                                                            ...
                                                            <section class="col col-2 col-auto">
                                                                ...
                                                                <label class="input"><i class="icon-append fa fa-usd"></i>
                                                                    <input type="text" placeholder="0,00" id="valorMinimo" name="valorMinimo" class="decimal-2-casas" autocomplete="off" />
                                                                </label>
                                                            </section>
                                                            <section class="col col-2 col-auto">
                                                                <label class="label" for="valorMaximo">Valor Máximo</label>
                                                                <label class="input"><i class="icon-append fa fa-usd"></i>
                                                                    <input type="text" placeholder="0,00" id="valorMaximo" name="valorMaximo" class="decimal-2-casas" autocomplete="off" />
                                                                </label>
                                                            </section>
