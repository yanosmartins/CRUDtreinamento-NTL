...
$condicaoAcessarOK = (in_array('VALETRANSPORTEUNITARIO_ACESSAR', $arrayPermissao, true));
$condicaoGravarOK = (in_array('VALETRANSPORTEUNITARIO_GRAVAR', $arrayPermissao, true));
...
$page_nav['beneficio']['sub']['cadastro']['sub']["valeTransporteUnitario"]["active"] = true;
                    ...
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false" style="">
                        ...
                        <div>
                            <div class="widget-body no-padding">
                                <form action="javascript:gravar()" class="smart-form client-form" id="formValeTransporteUnitarioFiltro" method="post">
                                                    ...
                                                    <fieldset>
                                                        <div class="row">
                                                            <section class="col col-3 col-auto">
                                                                <label class="label" for="transporteUnitario">Transporte Unitário</label>
                                                                <label class="input">
                                                                    <input id="transporteUnitario" name="transporteUnitario" type="text" autocomplete="off" />
                                                                </label>
                                                            </section>
                                                            <section class="col col-2 col-auto">
                                                                <label class="label" for="valorMinimo">Valor Mínimo</label>
                                                                <label class="input"><i class="icon-append fa fa-usd"></i>
                                                                    <input type="text" placeholder="0,00" id="valorMinimo" name="valorMinimo" class="text-right decimal-2-casas" autocomplete="off" />
                                                                </label>
                                                            </section>
                                                            <section class="col col-2 col-auto">
                                                                <label class="label" for="valorMaximo">Valor Máximo</label>
                                                                <label class="input"><i class="icon-append fa fa-usd"></i>
                                                                    <input type="text" placeholder="0,00" id="valorMaximo" name="valorMaximo" class="text-right decimal-2-casas" autocomplete="off" />
                                                                </label>
                                                            </section>
...
<script>
    ...
    function listarFiltro() {
        ...
        if (valorMinimo != "") {
            valorMinimo = parseFloat(valorMinimo.toString().replace(".", "").replace(",", ".")); //Transforma os valores em float.
        }
