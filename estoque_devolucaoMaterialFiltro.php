                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="row">
                                                            <section class="col col-2" id="sectionAprovado">
                                                                <label class="label" for="devolvido">Devolvido</label>
                                                                <label class="select">
                                                                    <select id="devolvido" name="devolvido" class="">
                                                                        <option></option>
...
<script>
    ...
    function listarFiltro() {
        ...
        var devolvido = $('#devolvido').val();
        var codigoItemId = $('#codigoItemId').val();


        $('#resultadoBusca').load('estoque_devolucaoMaterialFiltroListagem.php?', {
