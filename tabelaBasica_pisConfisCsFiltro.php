...
$page_nav['faturamento']['sub']['tabela']['sub']['retencaoTributaria']['sub']["pisConfisCs"]["active"] = true;
...
<script>
    ...
    function listarFiltro() {
        ...
        $('#resultadoBusca').load('tabelaBasica_pisConfisCsListagem.php?' + parametrosUrl);
    }
