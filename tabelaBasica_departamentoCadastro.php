...
$condicaoAcessarOK = (in_array('DEPARTAMENTO_ACESSAR', $arrayPermissao, true));
$condicaoGravarOK = (in_array('DEPARTAMENTO_GRAVAR', $arrayPermissao, true));
$condicaoExcluirOK = (in_array('DEPARTAMENTO_EXCLUIR', $arrayPermissao, true));
...
$page_nav['beneficio']['sub']['tabela']['sub']['departamento']["active"] = true;
include("inc/nav.php");
?>
...
?>
<script src="<?php echo ASSETS_URL; ?>/js/business_tabelaBasicaDepartamento.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript">
  $(document).ready(function() {
    ...
    $('#btnNovo').on("click", function() {
      $(location).attr('href', 'tabelaBasica_departamentoCadastro.php');
    });
  ...
  function voltar() {
    $(location).attr('href', 'tabelaBasica_departamentoFiltro.php');
  ...
  function excluir() {
    ...
    excluirDepartamento(id, function(data) {
