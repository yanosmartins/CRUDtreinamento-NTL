                                                            ...
                                                            <div class="row">
                                                                <section class="col col-4">
                                                                    ...
                                                                    <label class="input">
                                                                        ...
                                                                        <input id="clienteFornecedor" name="clienteFornecedorFiltro" autocomplete="off" class="form-control required" required placeholder="Digite o codigo..." type="text" value="">
                                                                ...
                                                                <section class="col col-2">
                                                                    ...
                                                                    <label class="input">
                                                                        <input id="numero" name="numero" maxlength="255" autocomplete="off" class="required" type="text" value="" required>
                                                                    </label>
                                                                </section>
                                                                <section class="col col-2">
