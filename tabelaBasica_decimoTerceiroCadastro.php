...
$condicaoAcessarOK = (in_array('DECIMOTERCEIRO_ACESSAR', $arrayPermissao, true));
$condicaoGravarOK = (in_array('DECIMOTERCEIRO_GRAVAR', $arrayPermissao, true));
$condicaoExcluirOK = (in_array('DECIMOTERCEIRO_EXCLUIR', $arrayPermissao, true));
...
$page_nav['faturamento']['sub']['tabela']['sub']['retencaoContaVinculada']['sub']["decimoTerceiro"]["active"] = true;
include("inc/nav.php");
?>
        ...
        <section id="widget-grid" class="">
            <!-- <div class="row" style="margin: 0 0 13px 0;">
                <?php if ($condicaoGravarOK) { ?>
                    <a class="btn btn-primary fa fa-file-o" aria-hidden="true" title="Novo" href="<?php echo APP_URL; ?>/cadastroDecimoTerceiro.php" style="float:right"></a>
                <?php } ?>
            </div> -->
                    ...
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
                        ...
                        <div>
                            <div class="widget-body no-padding">
                                <form action="javascript:gravar()" class="smart-form client-form" id="formDecimoTerceiro" method="post">
...
?>
<script src="<?php echo ASSETS_URL; ?>/js/business_tabelaBasicaDecimoTerceiro.js" type="text/javascript"></script>
