        ...
        <table id="tableSearchResult" class="table table-bordered table-striped table-condensed table-hover dataTable">
            <thead>
                <tr role="row">
                    ...
                    <th class="text-left" style="min-width:30px;">Descrição do Posto</th>
                    <th class="text-left" style="min-width:30px;">Valor do Posto</th>
            ...
            <tbody>
                ...
                if ($descricaoPosto != "") {
                    ...
                    $where = $where . " AND descricaoPosto = ". $descricaoPosto;
                }
                ...
                $reposit = new reposit();
                $sql = "SELECT VP.codigo, VP.projeto,P.descricao AS descricaoProjeto, VP.descricaoPosto, DP.descricao, valor
                 FROM Ntl.valorPosto VP
                 LEFT JOIN Ntl.projeto P ON VP.projeto = P.codigo
                LEFT JOIN Ntl.posto DP ON VP.descricaoPosto = DP.codigo";
                $sql = $sql . $where;
                ...
                foreach($result as $row) {
                    ...
                    echo '<tr >';
                    echo '<td class="text-left"><a href="cadastro_valorPostoCadastro.php?codigo=' . $codigo . '">' . $projeto . '</a></td>';
                    echo '<td class="text-left">' .  $descricaoPosto . '</td>';
