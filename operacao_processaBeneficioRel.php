...
$sql = "SELECT * , P.descricao as projetoDescricao , S.descricao as sindicatoDescricao, S.apelido as siglaSindicato, F.nome as funcionarioNome FROM Ntl.beneficioProjeto as BP 
inner join Ntl.projeto as P on BP.projeto = P.codigo
inner join Ntl.sindicato as S on BP.sindicato = S.codigo
inner join Ntl.funcionario as F on BP.funcionario = F.codigo
WHERE BP.codigo = " . $id;
    ...
    if (($row = odbc_fetch_array($result))) {
        ...
        INNER JOIN Ntl.beneficioProjetoPlanoSaudeTitular BS ON BP.codigo = BS.beneficioProjeto
        inner join Ntl.produto as P on BS.produto = P.codigo
        inner join Ntl.convenioSaude as C on BS.convenio = C.codigo
        ...
        $reposit = "";
        $result = "";
        $sql = "SELECT BP.codigo, BT.tipoDesconto, BT.transporte, BT.tipoVale, BT.trajeto, BT.valorTotal, BT.observacao, BT.trajetoIdaVolta FROM Ntl.beneficioProjeto BP
        INNER JOIN Ntl.beneficioProjetoVT BT ON BP.codigo = BT.beneficioProjeto WHERE BP.codigo = " . $id;
        $reposit = new reposit();
        $result = $reposit->RunQuery($sql);
...
$pdf->Cell(18, 5, iconv('UTF-8', 'windows-1252', "Funcionário :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(70, 5, iconv('UTF-8', 'windows-1252', $funcionario), 0, 0, "L", 0);
$pdf->Ln(5);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(29, 5, iconv('UTF-8', 'windows-1252', "Salário funcionário :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(30, 5, iconv('UTF-8', 'windows-1252', $salarioFuncionario), 0, 0, "L", 0);
$pdf->Ln(5);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(12, 5, iconv('UTF-8', 'windows-1252', "Projeto :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(140, 5, iconv('UTF-8', 'windows-1252', $projeto), 0, 0, "L", 0);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(22, 5, iconv('UTF-8', 'windows-1252', "Sigla sindicato :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
...
$constanteSegundaColuna = 17;
$constanteQuartaColuna = 17;
...
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell($constanteSegundaColuna, 5, iconv('UTF-8', 'windows-1252', "Julho :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
...
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell($constanteQuartaColuna, 5, iconv('UTF-8', 'windows-1252', "Julho :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
...
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(15, 5, iconv('UTF-8', 'windows-1252', "Fevereiro :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(35, 5, iconv('UTF-8', 'windows-1252', $diaUtilFevereiro), 0, 0, "L", 0);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell($constanteSegundaColuna, 5, iconv('UTF-8', 'windows-1252', "Agosto :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(30, 5, iconv('UTF-8', 'windows-1252', $diaUtilAgosto), 0, 0, "L", 0);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(15, 5, iconv('UTF-8', 'windows-1252', "Fevereiro :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(35, 5, iconv('UTF-8', 'windows-1252', $diaUtilFevereiroVT), 0, 0, "L", 0);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell($constanteQuartaColuna, 5, iconv('UTF-8', 'windows-1252', "Agosto :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
...
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell($constanteSegundaColuna, 5, iconv('UTF-8', 'windows-1252', "Setembro :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(30, 5, iconv('UTF-8', 'windows-1252', $diaUtilSetembro), 0, 0, "L", 0);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(15, 5, iconv('UTF-8', 'windows-1252', "Março :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(35, 5, iconv('UTF-8', 'windows-1252', $diaUtilMarcoVT), 0, 0, "L", 0);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell($constanteQuartaColuna, 5, iconv('UTF-8', 'windows-1252', "Setembro :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
...
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell($constanteSegundaColuna, 5, iconv('UTF-8', 'windows-1252', "Outubro :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
...
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell($constanteQuartaColuna, 5, iconv('UTF-8', 'windows-1252', "Outubro :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
...
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell($constanteSegundaColuna, 5, iconv('UTF-8', 'windows-1252', "Novembro :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(30, 5, iconv('UTF-8', 'windows-1252', $diaUtilNovembro), 0, 0, "L", 0);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(15, 5, iconv('UTF-8', 'windows-1252', "Maio :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(35, 5, iconv('UTF-8', 'windows-1252', $diaUtilMaioVT), 0, 0, "L", 0);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell($constanteQuartaColuna, 5, iconv('UTF-8', 'windows-1252', "Novembro :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
...
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell($constanteSegundaColuna, 5, iconv('UTF-8', 'windows-1252', "Dezembro :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(30, 5, iconv('UTF-8', 'windows-1252', $diaUtilDezembro), 0, 0, "L", 0);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(15, 5, iconv('UTF-8', 'windows-1252', "junho :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(35, 5, iconv('UTF-8', 'windows-1252', $diaUtilJunhoVT), 0, 0, "L", 0);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell($constanteQuartaColuna, 5, iconv('UTF-8', 'windows-1252', "Dezembro :"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
