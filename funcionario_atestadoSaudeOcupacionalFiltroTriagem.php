...
$page_nav["beneficio"]["sub"]["triagem"]["sub"]["filtroTriagem"]["active"] = true;
...
<script>
    ...
    function listarFiltro() {
        ...
        $('#resultadoBusca').load('funcionario_atestadoSaudeOcupacionalFiltroListagemTriagem.php?' + parametrosUrl);
    }
</script>