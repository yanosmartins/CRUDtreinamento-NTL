...
function listaDescricaoAtivoAutoComplete()
{
    ...
    foreach ($result as $row) {
        ...
        $contador = $contador + 1;
        $array[] = array("id" => $id, "descricao" => $descricaoItem, "codigoItem" => $codigoItem, "unidade" => $unidade, "estoque" => $estoque, "unidadeItem" => $unidadeItem);
    }
...
function listaCodigoAtivoAutoComplete()
{
    ...
    foreach ($result as $row) {
        ...
        $contador = $contador + 1;
        $array[] = array("id" => $id, "descricao" => $codigoItem, "descricaoItem" => $descricaoItem, "unidade" => $unidade, "estoque" => $estoque, "unidadeItem" => $unidadeItem);
    }
