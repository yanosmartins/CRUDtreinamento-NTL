...
$condicaoAcessarOK = (in_array('MULTAFGTS_ACESSAR', $arrayPermissao, true));
$condicaoGravarOK = (in_array('MULTAFGTS_GRAVAR', $arrayPermissao, true));
$condicaoGravarOK = (in_array('MULTAFGTS_EXCLUIR', $arrayPermissao, true));
...
$page_title = "Multa FGTS por Dispensa sem Justa Causa";
...
$page_nav['tabelaBasica']['sub']['retencaoContaVinculada']['sub']["multaFGTS"]["active"] = true;
include("inc/nav.php");
?>
        ...
        <section id="widget-grid" class="">
            <!-- <div class="row" style="margin: 0 0 13px 0;">
                <?php if ($condicaoGravarOK) { ?>
                    <a class="btn btn-primary fa fa-file-o" aria-hidden="true" title="Novo" href="<?php echo APP_URL; ?>/cadastroMulta.php" style="float:right"></a>
                <?php } ?>
            </div> -->
                ...
                <article class="col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable centerBox">
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
                        <header>
                            ...
                            <h2>Multa FGTS por Dispensa sem Justa Causa
                            </h2>
                        </header>
                        <div>
                            <div class="widget-body no-padding">
                                <form action="javascript:gravar()" class="smart-form client-form" id="formMulta" method="post">
...
?>
<script src="<?php echo ASSETS_URL; ?>/js/business_tabelaBasicaMultaFgts.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript"> 
    ...
    function voltar() {
        $(location).attr('href', 'tabelaBasica_multaFgtsFiltro.php');
...
//Botão que desabilita a gravação até que ocorra uma mensagem de erro ou sucesso.
   ...
   gravaMultaFgts(codigo, ativo, percentual,
    ...
    function excluir() {
        ...
        excluirMultaFgts(id, function(data) {
