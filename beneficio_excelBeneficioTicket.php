...
$inputFileName = 'planilhas/Pasta1.xlsx';
...
$sheet = $spreadsheet->getSheetByName("Planilha1");
...
$sheetDadosEmpresa = $spreadsheet->getSheetByName("Planilha1");
...
// $sheet3 = $spreadsheet->getSheetByName("Planilha1");
