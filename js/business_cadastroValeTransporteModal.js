function gravaValeTransporteModal(id, ativo, descricao, valorTotal, jsonValeTransporteModal, callback) {
    $.ajax({
        url: 'js/sqlscope_tabelaBasicaValeTransporteModal.php',
        dataType: 'html', //tipo do retorno
        type: 'post', //metodo de envio
        data: {funcao: "grava", id:id, ativo:ativo, descricao:descricao, valorTotal: valorTotal, jsonValeTransporteModal: jsonValeTransporteModal
        },   
...
function recuperaValeTransporteModal(id, callback) {
    $.ajax({
        url: 'js/sqlscope_tabelaBasicaValeTransporteModal.php', //caminho do arquivo a ser executado
        dataType: 'html', //tipo do retorno
        type: 'post', //metodo de envio
