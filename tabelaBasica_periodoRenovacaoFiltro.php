...
$page_title = "Periodo de Renovação";
...
$page_nav['faturamento']['sub']['tabela']['sub']["periodoRenovacao"]["active"] = true;
                ...
                <article class="col-sm-12 col-md-12 col-lg-12 sortable-grid ui-sortable centerBox">
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false" >
                        <header>
                            ...
                            <h2>Periodo de Renovação</h2>
                        </header>
                        <div>
                            <div class="widget-body no-padding">
                                <form action="javascript:gravar()" class="smart-form client-form" id="formPeriodoRenovacaoFiltro" method="post">
