...
$condicaoAcessarOK = (in_array('PREGAOEXTRAPROCESSO_ACESSAR', $arrayPermissao, true));
$condicaoGravarOK = (in_array('PREGAOEXTRAPROCESSO_GRAVAR', $arrayPermissao, true));
...
$page_nav["licitacao"]["sub"]["operacao"]["sub"]["pregoesExtraProcesso"]["active"] = true;
...
<script>
    ...
    function listarFiltro() {
        ...
        if (tipoPesquisa == "0") {
            $('#resultadoBusca').load('licitacao_pregaoExtraProcessoFiltroListagem.php?', {
                portal: portal,
