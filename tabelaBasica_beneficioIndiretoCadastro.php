...
$condicaoGravarOK = (in_array('BENEFICIOINDIRETO_EXCLUIR', $arrayPermissao, true));
...
$page_nav["tabelaBasica"]["sub"]["beneficioIndireto"]["active"] = true;
...
<script src="<?php echo ASSETS_URL; ?>/js/business_tabelaBasicaBeneficioIndireto.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript">
    ...
    function voltar() {
        $(location).attr('href', 'tabelaBasica_beneficioIndiretoFiltro.php');
    }
