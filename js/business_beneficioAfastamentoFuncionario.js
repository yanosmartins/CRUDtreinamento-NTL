...
function gravaAfastamentoFuncionario(id, funcionario, mesAno, motivoAfastamento, dataInicio, dataFim,
    ...
    $.ajax({
        url: 'js/sqlscope_beneficioAfastamentoFuncionario.php',
        dataType: 'html', //tipo do retorno
        type: 'post', //metodo de envio
        data: {
            funcao: "grava", id: id, funcionario: funcionario, mesAno: mesAno, motivoAfastamento: motivoAfastamento, dataInicio: dataInicio, dataFim: dataFim,
...
function recuperaAfastamentoFuncionario(id, callback) {
    $.ajax({
        url: 'js/sqlscope_beneficioAfastamentoFuncionario.php', //caminho do arquivo a ser executado
        dataType: 'html', //tipo do retorno
        type: 'post', //metodo de envio
