...
$page_nav["operacao"]["sub"]['faturamento']['sub']["remuneracao"]["active"] = true;
                            ...
                            <div class="table-responsive" style="min-height: 115px; border: 1px solid #ddd; margin-bottom: 13px; overflow-x: auto;">
                                <table id="tableSearchResult" class="table table-bordered table-striped table-condensed table-hover dataTable">
                                    ...
                                    <tbody>
                                        <?php
                                        echo '<tr >';
                                        echo '<td class="text-left"><a href="tabelaBasica_lancamentoCadastro.php?codigo=' . $id . '">Salário</a></td>';
                                        echo '<td class="text-left">Sim</td>';
                                        echo '</tr >';
                                        echo '<tr >';
                                        echo '<td class="text-left"><a href="tabelaBasica_lancamentoCadastro.php?codigo=' . $id . '">Bonificação</a></td>';
                                        echo '<td class="text-left">Sim</td>';
                                        echo '</tr >';
                                        echo '<tr >';
                                        echo '<td class="text-left"><a href="tabelaBasica_lancamentoCadastro.php?codigo=' . $id . '">Auxilio Extra</a></td>';
                                        echo '<td class="text-left">Sim</td>';
                                        echo '</tr >';
                                        ?>
                                    </tbody>
...
<script>
    $(document).ready(function() {
        ...
        $('#btnNovo').on("click", function() {
            $(location).attr('href', 'prototipoValorPosto_tabelaBasicaRemuneracaoCadastro.php');
        });
    });
