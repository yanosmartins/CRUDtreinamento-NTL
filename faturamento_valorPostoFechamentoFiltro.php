...
$page_nav['faturamento']['sub']['cadastro']['sub']["projetoPostoFechamento"]["active"] = true;
                    ...
                    <div>
                        <div class="widget-body no-padding">
                            <form action="javascript:gravar()" class="smart-form client-form" id="formRetencaoTributariaFiltro" method="post">
                                ...
                                <footer>
                                    <button id="calculaGrupoModal" type="button" class="btn btn-danger pull-left" aria-hidden="true" title="btn">
                                        Fechamento
                                    </button>
...
<script>
    ...
    function listarFiltro() {
        ...
        $('#resultadoBusca').load('faturamento_valorPostoFechamentoFiltroListagem.php?' + parametrosUrl);
    }
</script>