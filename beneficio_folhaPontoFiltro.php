                    ...
                    <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false" style="">
                        ...
                        <div>
                            <div class="widget-body no-padding">
                                <form action="javascript:gravar()" class="smart-form client-form" id="formFolhaPontoFiltro" method="post">
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <section class="col col-3">
                                                            ...
                                                            <section class="col col-3">
                                                                ...
                                                                <label class="input">
                                                                    <input id="funcionario" name="funcionario" autocomplete="off">
                                                                </label>
                                                            </section> 
                                                            <section class="col col-2 col-auto">
                                                                <label class="label" for="mesAno">Mês/Ano</label>
                                                                <label class="input">
                                                                    <input id="mesAnoFolhaPonto" name="mesAnoFolhaPonto" autocomplete="off" data-mask="99/9999" data-mask-placeholder="mm/aaaa" data-dateformat="mm/yy" placeholder="mm/aaaa" type="text" class="datepicker" value="">
                                                                </label>
                                                            </section>  
                                                        </div>
                                                    </fieldset>
...
<script>
    ...
    function listarFiltro() {
        ...
        var parametrosUrl = '&projeto=' + projeto + '&funcionario=' + funcionario + '&mesAnoFolhaPonto=' + mesAnoFolhaPonto;
