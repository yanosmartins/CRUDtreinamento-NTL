...
$condicaoExcluirOK = (in_array('AFASTAMENTOFUNCIONARIO_EXCLUIR', $arrayPermissao, true));
...
$page_nav["beneficio"]["sub"]["operacao"]["sub"]["afastamentoFuncionario"]["active"] = true;
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <section class="col col-4 col-auto">
                                                                <label class="label" for="motivoAfastamento">Motivo do Afastamento</label>
                                                                <label class="select">
                                                                    <select id="motivoAfastamento" name="motivoAfastamento" class="required">
                                                                        <option></option>
                                                                        <?php
                                                                        $reposit = new reposit();
                                                                        $sql = "select codigo, descricao from Ntl.motivoAfastamento where ativo = 1 order by descricao";
                                                                        $result = $reposit->RunQuery($sql);
                                                                        foreach($result as $row) {
                                                                            $codigo = (int) $row['codigo'];
                                                                            $descricao = $row['descricao'];
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <section class="col col-1">
                                                                <label class="label" for="quantidadeDias">Dias Corridos</label>
                                                                <label class="select">
                                                            ...
                                                            <section class="col col-1">
                                                                <label class="label" for="dataFim">Dias Abater</label>
                                                                <label class="input">
                                                                    <i class=""></i>
                                                            ...
                                                            <section class="col col-1">
                                                                <label class="label" for="diaFeriado">Dias de Feriado (no periodo)</label>
                                                                <label class="input">
                                                                    <i class=""></i>
                                                                    <input id="diaFeriado" name="diaFeriado" autocomplete="" type="text" class="readonly" readonly value="">
                                                                </label>
                                                            </section>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <section class="col col-2 col-auto">
                                                                <label class="label" for="descontarRefeicao">Descontar Alimentação/Refeição/</label>
                                                                <label class="select">
                                                                    <select id="descontarVAVR" name="descontarVAVR" class="required">
                                                                        <option></option>
                                                            ...
                                                            <section class="col col-2 col-auto">
                                                                <label class="label" for="descontarTransporte">Descontar Transporte</label>
                                                                <label class="select">
                                                                    <select id="descontarTransporte" name="descontarTransporte" class="required">
                                                                        <option></option>
                                                                        <option value="0">Não</option>
                                                                        <option value="1">Sim</option>
                                                                    </select><i></i>
                                                            ...
                                                            <section class="col col-2 col-auto">
                                                                <label class="label" for="descontarCestaBasica">Descontar Cesta Básica</label>
                                                                <label class="select">
                                                                    <select id="descontarCestaBasica" name="descontarCestaBasica" class="required">
                                                                        <option></option>
                                                                        <option value="0">Não</option>
                                                                        <option value="1">Sim</option>
                                                                    </select><i></i>
                                                        ...
                                                        <div class="row">
                                                            <section class="col col-12">
                                                                ...
                                                                <textarea id="justificativa" name="justificativa" maxlength="2000" class="form-control" maxlength="2000" rows="2" style="resize:vertical "></textarea>
                                                            </section>
                                                        </div>
                                                    </fieldset>
                                                </div>
...
<script src="<?php echo ASSETS_URL; ?>/js/business_beneficioAfastamentoFuncionario.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript">
    ...
    function carregaPagina() {
        ...
        if (params.length === 2) {
            ...
            var idd = idx[1];
            if (idd !== "") {
                recuperaAfastamentoFuncionario(idd,
                    function(data) {
                        ...
                        var mesAno = piece[3];
                        var motivoAfastamento = +piece[4];
                        var dataInicio = piece[5];
                        var dataFim = piece[6];
                        var quantidadeDias = +piece[7];
                        var diaUtil = +piece[8];
                        var descontarVAVR = +piece[9];
                        var descontarTransporte = +piece[10];
                        var descontarCestaBasica = +piece[11];
                        var justificativa = piece[12];
                        var diaFeriado = +piece[13];
                        var projeto = +piece[14];

                        $("#codigo").val(codigo);
                        $("#ativo").val(ativo);
                        $("#funcionario").val(funcionario);
                        $("#mesAno").val(mesAno);
                        $("#motivoAfastamento").val(motivoAfastamento);
                        $("#dataInicio").val(dataInicio);
                        $("#dataFim").val(dataFim);
                        $("#quantidadeDias").val(quantidadeDias);
                        $("#diaUtil").val(diaUtil);
                        $("#descontarVAVR").val(descontarVAVR);
                        $("#descontarTransporte").val(descontarTransporte);
                        $("#descontarCestaBasica").val(descontarCestaBasica);
                        $("#justificativa").val(justificativa);
                        $("#diaFeriado").val(diaFeriado);
                        $("#projeto").val(projeto);
    ...
    function gravar() {
        ...
        var mesAno = $("#mesAno").val();
        var motivoAfastamento = $("#motivoAfastamento").val();
        var dataInicio = $("#dataInicio").val();
        var dataFim = $("#dataFim").val();
        var quantidadeDias = +$("#quantidadeDias").val();
        ...
        var descontarVAVR = $("#descontarVAVR").val();
        var descontarTransporte = $("#descontarTransporte").val();
        var descontarCestaBasica = $("#descontarCestaBasica").val();
        ...
        if (!descontarVAVR) {
            smartAlert("Atenção", "Informe o Desconto VAVR ", "error");
            $("#btnGravar").prop('disabled', false);
            return;
        }
        if (!descontarTransporte) {
            smartAlert("Atenção", "Informe o Desconto Transporte ", "error");
            $("#btnGravar").prop('disabled', false);
            return;
        }

        if (!descontarCestaBasica) {
            smartAlert("Atenção", "Informe o Desconto Cesta Basica ", "error");
            $("#btnGravar").prop('disabled', false);
            return;
        }

        gravaAfastamentoFuncionario(id, funcionario, mesAno, motivoAfastamento, dataInicio, dataFim,
            quantidadeDias, diaUtil, mesAnoInicio, mesAnoFim, descontarVAVR, descontarTransporte, descontarCestaBasica,
            justificativa, diaFeriado, projeto,
            function(data) {
                if (data.indexOf('failed') > -1) {
                    var piece = data.split("#");
                    var mensagem = piece[1];
        ...
        contaFeriado(funcionario, mesAno, dataInicio, dataFim, quantidadeDias, adiantaDecimoTerceiro, mesAnoInicio, mesAnoFim, diaUtil,
            function(data) {
                if (data.indexOf('failed') > -1) {
                    ...
                    $("#diaFeriado").val(contadorFeriado);
