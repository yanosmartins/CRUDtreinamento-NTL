...
<div class="table-container">
    <div class="table-responsive" style="min-height: 115px; border: 1px solid #ddd; margin-bottom: 13px; overflow-x: auto;">
        <table id="tableSearchResult" class="table table-bordered table-striped table-condensed table-hover dataTable">
            <thead>
                <tr role="row">
                    <th class="text-left" style="min-width:30px;">Lançamento</th>
                    <th class="text-left" style="min-width:35px;">Sigla</th>
            ...
            <tbody>
                <?php 
                    ...
                    if ($_GET["siglaFiltro"] != "" ) {
                        $siglaFiltro = "'" . $_GET["siglaFiltro"] . "'";
                        $where = $where." AND sigla = $siglaFiltro";
                    }
                    ...
                    $sql = "SELECT codigo,descricao,sigla,ativo FROM Ntl.lancamento";
                    $sql = $sql.$where;
                    ...
                    foreach($result as $row) {
                        ...
                        echo '<tr >'; 
                        echo '<td class="text-left"><a href="tabelaBasica_lancamentoCadastro.php?codigo='.$id.'">'.$descricao.'</a></td>';
