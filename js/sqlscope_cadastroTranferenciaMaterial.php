...
function grava()
{
    ...
    $codigoItemId =  (int)$_POST['codigoItemId'] ?: 0;
    $unidadeDestino =  (int)$_POST['unidadeDestino'] ?: 0;
    $estoqueDestino =  (int)$_POST['estoqueDestino'] ?: 0;
    $estoque =  (int)$_POST['estoque'] ?: 0;
    $quantidade =  (int)$_POST['quantidade'] ?: 0;
    $motivo =  $_POST['motivo'];

    $sql = "Estoque.transferenciaMaterial_Atualiza
        $codigo,
        $estoque,
        $codigoItemId,
        $unidadeDestino,
