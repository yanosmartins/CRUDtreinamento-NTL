        ...
        <table id="tableSearchResult" class="table table-bordered table-striped table-condensed table-hover dataTable">
            ...
            <tbody>
                ...
                $sql = "SELECT DISTINCT BP.funcionario, FU.codigo AS codigoFuncionario,FU.nome, BP.codigo, 
                        ...
                        BP.produtoVAVR,PB.codigoBeneficio,BP.produtoBeneficioIndireto,PBI.codigoBeneficio AS codigoBeneficioIndireto
                        ...
                        LEFT JOIN Beneficio.produtoBeneficio PBI ON BP.produtoBeneficioIndireto = PBI.codigo 
                ...
                foreach ($result1 as $row) {
                    ...
                    $codigoBeneficioIndireto = $row['codigoBeneficioIndireto'];
                    ...
                    $arrayProcessabeneficio[] = array(
                        ...
                        "produtoBeneficioIndireto" => $produtoBeneficioIndireto,
                        "codigoBeneficioIndireto" => $codigoBeneficioIndireto,
                    );
                }
