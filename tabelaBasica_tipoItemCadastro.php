...
$condicaoExcluirOK = (in_array('TIPOITEM_EXCLUIR', $arrayPermissao, true));
...
$page_nav["estoque"]["sub"]["tabela"]["sub"]["tipoItem"]["active"] = true;
...
<script src="<?php echo ASSETS_URL; ?>/js/business_tabelaBasicaTipoItem.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript">
    ...
    function voltar() {
        $(location).attr('href', 'tabelaBasica_tipoItemFiltro.php');
    }
