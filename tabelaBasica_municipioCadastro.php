...
$condicaoExcluirOK = (in_array('MUNICIPIO_EXCLUIR', $arrayPermissao, true));
...
<script src="<?php echo ASSETS_URL; ?>/js/business_tabelaBasicaMunicipio.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript">
    ...
    function voltar() {
        $(location).attr('href', 'tabelaBasica_municipioFiltro.php');
    }
    ...
    function gravar() {
        ...
        gravaMunicipio(id, ativo, descricao, unidadeFederacao,
            function(data) {
