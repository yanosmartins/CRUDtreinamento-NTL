...
<!-- INCLUI ESSE SCRIPT PARA FORMATAR VALOR -->
<script src="<?php echo ASSETS_URL; ?>/js/plugin/jquery.price_format.2.0.js"></script>                

<script src="<?php echo ASSETS_URL; ?>/js/gir_script.js" type="text/javascript"></script>     

<script src="<?php echo ASSETS_URL; ?>/js/plugin/cpfcnpj/jquery.cpfcnpj.min.js" type="text/javascript"></script>     
