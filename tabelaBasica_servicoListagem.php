...
<div class="table-container">
    <div class="table-responsive" style="min-height: 115px; border: 1px solid #ddd; margin-bottom: 13px; overflow-x: auto;">
        <table id="tableSearchResult" class="table table-bordered table-striped table-condensed table-hover dataTable">
            <thead>
                <tr role="row">
                    <th class="text-left" style="min-width:30px;">Código de Serviço</th>
                    <th class="text-left" style="min-width:30px;">Descrição do Serviço</th>
            ...
            <tbody>
                ...
                foreach($result as $row) {
                    ...
                    echo '<tr>';
                    echo '<td class="text-left"><a href="tabelaBasica_servicoCadastro.php?codigo=' . $codigo . '">'  . $descricaoCodigo . '</a></td>';
                    echo '<td class="text-left">' . $descricaoServico . '</td>';
                    if ($ativo == 1) {
