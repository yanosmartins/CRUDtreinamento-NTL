...
$condicaoExcluirOK = (in_array('CONVENIOSAUDE_EXCLUIR', $arrayPermissao, true));
...
$page_nav['beneficio']['sub']['cadastro']['sub']["convenioSaude"]["active"] = true;
...
<script src="<?php echo ASSETS_URL; ?>/js/business_cadastroConvenioSaude.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript">
    ...
    function voltar() {
        $(location).attr('href', 'cadastro_convenioSaudeFiltro.php');
    }
