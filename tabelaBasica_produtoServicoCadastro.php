...
$condicaoExcluirOK = (in_array('PRODUTOSERVICO_EXCLUIR', $arrayPermissao, true));
...
<script src="<?php echo ASSETS_URL; ?>/js/business_tabelaBasicaProdutoServico.js" type="text/javascript"></script>
...
<script language="JavaScript" type="text/javascript">
    ...
    function voltar() {
        $(location).attr('href', 'tabelaBasica_produtoServicoFiltro.php');
    }
    ...
    function gravar() {
        ...
        gravaProdutoServico(id, ativo, descricao,
            function(data) {
