        ...
        <table id="tableSearchResult" class="table table-bordered table-striped table-condensed table-hover dataTable">
            <thead>
                <tr role="row">
                    ...
                    <th class="text-left" style="min-width:80px;">Material</th>
                    <th class="text-left" style="min-width:100px;">Estoque</th>
                    <th class="text-left" style="min-width:300px;">Quantidade</th>
                    <th class="text-left" style="min-width:300px;">Quantidade Em Estoque</th>
                    <th class="text-left" style="min-width:30px;">Quantidade Fora de Estoque</th>
                    <th class="text-left" style="min-width:150px;">Quantidade Reservada</th>
                </tr>
            </thead>
            <tbody>
                <?php
